...
// import { fetchProductSearch } from "../../store/slices/productSeachSlices";
      ...
      {search && (
        <Box
          sx={{
            ...
            width: "400px",
            zIndex: 1,
            marginTop: "5px", // Thêm khoảng cách giữa ô input và danh sách kết quả
            borderRadius: "4px", // Thêm bo góc cho danh sách kết quả
            boxShadow: 2, // Thêm bóng cho danh sách kết quả
          }}
        >
